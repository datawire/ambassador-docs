...
const Sidebar: React.FC<ISidebarProps> = ({
  ...
  const getLinkId = (item: ITopicItem) =>
    item.link ? item.link : item.title.replace(/\s+/g, '-').toLowerCase();
  ...
  return (
    <div className="docs__doc-sidebar docs__desktop">
          ...
          {isVersionOpen && (
            <>
              ...
              <Flyout
                ...
                selected={
                  version.archived ? archivedVersionsLink.id : version.id
                }
              />
            </>
          )}
      ...
      <div
        className="docs__topic-list-content"
