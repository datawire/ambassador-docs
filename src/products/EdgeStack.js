...
const EdgeStack = () => {
  const initialCards = EdgeStackCards.filter(
    (c) => c.section === EdgeStackSections[0].id,
  );
  ...
  return (
    <section className="docs__started docs__container product-page">
      ...
      <p>
        Route and secure traffic to your cluster with a Kubernetes-native API
        Gateway built on the Envoy Proxy.
      </p>
      <Link
        to={goToEdgeStackQuickStart}
