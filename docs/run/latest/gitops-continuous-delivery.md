---
description: Run with the power of Edge Stack, continuous delivery, and GitOps  
---

# Run with Edge Stack

Edge Stack is a powerful product that enables you to Run your deployments securely, simply, and efficiently. With proper GitOps practice and Ambassador Labs' Edge Stack, you can boost your continuous delovery workflow with the following advantages:
