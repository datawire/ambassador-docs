...
You can add any type of [Kubernetes Service](https://kubernetes.io/docs/concepts/services-networking/service/) to the service catalog. 
...
Please find the entire list of supported metadata values [here](../reference/annotations).

**How can I add metadata to a service within the catalog?**

Please find instructions on this [here](../reference/annotations/#annotate-via-kubectl)
