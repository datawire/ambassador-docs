...
If you are using the [Telepresence Docker Extension](../extension/intro) you will need to ensure that your `command` is set to an absolute path in your kubeconfig file instead of a relative path.
