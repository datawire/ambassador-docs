---
description: "Install Telepresence Quick Start - Python (Flask) and learn to use it to intercept services running in your Kubernetes cluster. Speeding up local development..."
---
...
Invoke-WebRequest https://app.getambassador.io/download/tel2/windows/amd64/$dlVersion$/telepresence.zip -OutFile telepresence.zipe.zip
