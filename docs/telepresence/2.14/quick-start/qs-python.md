---
description: "Telepresence Quick Start - Python (Flask). This document uses kubectl in all example commands, but OpenShift users should have no problem substituting in the oc."
---
