---
description: "Telepresence Quick Start - Java. This document uses kubectl in all example commands, but OpenShift users should have no problem substituting in the oc command."
---
