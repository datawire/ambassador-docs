---
description: "Telepresence Quick Start Node.js. This document uses kubectl in all example commands. OpenShift users should have no problem substituting in the oc command..."
---
