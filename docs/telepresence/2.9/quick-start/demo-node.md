...
<DockerCommand osType="macos" language='demo-node' version='latest'/>

</Platform.MacOSTab>
<Platform.GNULinuxTab>

<DockerCommand osType="linux" language='demo-node' version='latest'/>

</Platform.GNULinuxTab>
<Platform.WindowsTab>

<DockerCommand osType="windows" language='demo-node' version='latest'/>
...
1. From your Docker container, create an intercept, which will tell Telepresence to send traffic to the service in your container instead of the service in the cluster:
   `telepresence intercept web --port 8080`
    ...
    <UserInterceptCommand version="latest" />
