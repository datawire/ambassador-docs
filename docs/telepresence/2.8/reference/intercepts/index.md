...
[ambassador-agent]: https://github.com/telepresenceio/telepresence/blob/release/v2.4/pkg/client/cli/extensions/builtin.go#L30-L50
...
can do that easily by going to [Ambassador Cloud -> Intercepts history](https://app.getambassador.io/cloud/saved-intercepts/history)
