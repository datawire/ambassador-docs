...
1. Run the Docker container locally, by running this command inside your local terminal:
  ...
  <Platform.TabGroup>
    <Platform.MacOSTab>
      <DockerCommand osType="macos" language="go" version='latest' />
    </Platform.MacOSTab>

    <Platform.GNULinuxTab>
      <DockerCommand osType="linux" language="go" version='latest' />
    </Platform.GNULinuxTab>

    <Platform.WindowsTab>
      <DockerCommand osType="windows" language="go" version='latest' />
    </Platform.WindowsTab>
  </Platform.TabGroup>
