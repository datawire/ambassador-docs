...
A new Helm value file following the naming convention `a8r-values-<ENVIRONMENT_name>}.yaml`
will be generated with values for the rollout configuration. These values will later be used inside  to
...
You'll see a "Merge the Pull Request" button that will take you to the pull request where you can approve it and merge it.
...
<Alert severity="warning">
    A "Refresh" or "Hard Refresh" of the application might be needed to allow Argo CD to see the new _values_ file
