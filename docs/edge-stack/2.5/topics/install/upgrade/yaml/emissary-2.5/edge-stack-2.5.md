...
<Alert severity="warning">
  ...
  If you originally installed with Helm, see the <a href="../../../helm/emissary-2.5/edge-stack-2.5">Helm-based
...
4. **Be careful about label selectors on Kubernetes Services!**
   ...
   If you have services in $OSSproductName$ 2.5 that use selectors that will match
   Pods from $AESproductName$ $version$, traffic will be erroneously split between
   $OSSproductName$ 2.5 and $AESproductName$ $version$. The labels used by $AESproductName$
   $version$ include:
