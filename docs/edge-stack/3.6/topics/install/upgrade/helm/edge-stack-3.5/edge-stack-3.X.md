...
# Upgrade $productName$ 3.5.X to $productName$ $version$ (Helm)
...
<Alert severity="warning">
  ...
  If you did not originally install with Helm, see the <a href="../../../yaml/edge-stack-3.5/edge-stack-3.X">YAML-based
