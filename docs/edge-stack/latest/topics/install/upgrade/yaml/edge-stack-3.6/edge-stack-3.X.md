...
# Upgrade $productName$ 3.6.Z to $productName$ $version$ (YAML)
...
<Alert severity="warning">
  ...
  If you originally installed with Helm, see the <a href="../../../helm/edge-stack-3.6/edge-stack-3.X">Helm-based
