...
<Alert severity="info">$productName$ is subject to the Ambassador Cloud connected clusters quota, you can see that and other quotas [here](../../../cloud/latest/subscriptions/howtos/manage-my-subscriptions.md)</Alert>
