...
```bash
wget https://app.getambassador.io/download/waf/v1-20230612/aes-waf.conf
wget https://app.getambassador.io/download/waf/v1-20230612/crs-setup.conf
wget https://app.getambassador.io/download/waf/v1-20230612/waf-rules.conf
```
...
Files:
- [aes-waf.conf](https://app.getambassador.io/download/waf/v1-20230612/aes-waf.conf)
- [crs-setup.conf](https://app.getambassador.io/download/waf/v1-20230612/crs-setup.conf)
- [waf-rules.conf](https://app.getambassador.io/download/waf/v1-20230612/waf-rules.conf)
