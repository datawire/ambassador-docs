...
* In an AuthService, the `tls` field may either be a Boolean, or a
  string referring to a `TLSContext`.  In an `External` filter, it may
  only be a Boolean; referring to a TLS context is not supported.
* In an AuthService, the `add_linkerd_headers` field defaults based on
  the [`ambassador` `Module`](../../../running/ambassador).  In an
  External filter, it defaults to `false`.
...
| `tls`                        | `true` if `auth_service` starts with "https://"             | Whether to use TLS or cleartext when speaking to the external auth service.  The default is based on the scheme-part of the `auth_service`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
