...
| Edge Stack                        | [`AES_RATELIMIT_PREVIEW`](../aes-extensions/rate-limiting#aes-ratelimit_preview)         | `false`                                             | Boolean; [Go `strconv.ParseBool`][] |
...
| RateLimit                         | [`LOCAL_CACHE_SIZE_IN_BYTES`](../aes-extensions/rate-limiting#local_cache_size_in_bytes) | `0`                                                 | Requires AES_RATELIMIT_PREVIEW; Integer |
| RateLimit                         | [`NEAR_LIMIT_RATIO`](../aes-extensions/rate-limiting#near_limit_ratio)                   | `0.8`                                               | Requires AES_RATELIMIT_PREVIEW; Float; [Go `strconv.ParseFloat`][] || Developer Portal | `AMBASSADOR_URL` | `https://api.example.com` | URL |
