...
<Alert severity="info">
  If you are using a demo cluster or followed the <a href="../../../../edge-stack/latest/tutorials/getting-started/">Edge Stack quick start</a>, you can skip this step.
</Alert>
...
* [Rollout references](../reference/rollouts): Dive into the details of Argo configurations and Ambassador Cloud rollouts annotations.
