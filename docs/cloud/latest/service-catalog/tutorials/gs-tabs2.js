  ...
  return (
    <div className={classes.root}>
      ...
      <TabPanel value={value} index={0}>
        ...
        Log in to{' '}
        <a href="https://app.getambassador.io/cloud/">Ambassador Cloud</a>.
        Click <b>Connect my cluster to Ambassador Cloud</b>, then{' '}
        <b>Connect via Helm</b>. The slideout contains instructions with a
      ...
      <TabPanel value={value} index={2}>
        ...
        <a href="https://app.getambassador.io/cloud/">Ambassador Cloud</a>.
        Click <b>Connect my cluster to Ambassador Cloud</b>, then{' '}
        <b>Connect via Kubernetes YAML</b>. The slideout contains instructions
        with a unique <code>cloud-connect-token</code> that is used to connect
      ...
      <TabPanel value={value} index={3}>
        ...
        Connecting Edge Stack that was installed via <code>edgectl</code> is
