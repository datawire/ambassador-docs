...
Note for this to work, you need to make sure you've properly configured $AESproductName$ to [propagate your original client IP address](/docs/edge-stack/latest/topics/running/ambassador/#trust-downstream-client-ip).
