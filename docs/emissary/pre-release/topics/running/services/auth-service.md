...
| `include_body.body_raw_bytes` | (none; defaults to `false` if `include_body` is not `null`)                         | Controls if the body of the request is sent to the external auth service as a binary upload.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
