...
# Upgrade $productName$ 2.0.5 to $AESproductName$ $version$ (YAML)
...
<Alert severity="warning">
  ...
  If you originally installed with Helm, see the <a href="../../../helm/emissary-2.0/edge-stack-2.1">Helm-based
...
2. **Install $AESproductName$ $version$.**
   ...
   **in the same namespace as your existing $productName$ 2.0.5 installation**. It's important
   ...
   Our `aes-emissaryns-migration.yaml` assumes that $productName$ 2.0.5 is installed in the
   `emissary` namespace. If you installed $productName$ 2.0.5 into a different namespace, you'll
